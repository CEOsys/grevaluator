...
class ConditionDefinition(metadataresource.MetadataResource):
    ...
    def elements_sequence(cls):
        """returning all elements names from ``ConditionDefinition`` according specification,
...
class ConditionDefinitionMedication(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ConditionDefinitionMedication`` according specification,
        with preserving original sequence order.
        """
...
class ConditionDefinitionObservation(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ConditionDefinitionObservation`` according specification,
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "category", "code"]
...
class ConditionDefinitionPlan(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ConditionDefinitionPlan`` according specification,
        with preserving original sequence order.
        """
...
class ConditionDefinitionPrecondition(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ConditionDefinitionPrecondition`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class ConditionDefinitionQuestionnaire(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ConditionDefinitionQuestionnaire`` according specification,
        with preserving original sequence order.
        """
