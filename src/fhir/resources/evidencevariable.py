...
class EvidenceVariable(metadataresource.MetadataResource):
...
class EvidenceVariableCategory(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``EvidenceVariableCategory`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class EvidenceVariableCharacteristicTimeFromStart(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``EvidenceVariableCharacteristicTimeFromStart`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
