...
class Procedure(domainresource.DomainResource):
    ...
    reason: typing.List[fhirtypes.CodeableReferenceType] = Field(
        ...
        description=(
            ...
            "may be a coded entity of some type, or may simply be present as text, "
            "or may be a reference to one of several resources that justify the "
            "procedure."
        ),
        # if property is element of this resource.
        element_property=True,
    ...
    subject: fhirtypes.ReferenceType = Field(
        ...
        description=(
            "On whom or what the procedure was performed. This is usually an "
