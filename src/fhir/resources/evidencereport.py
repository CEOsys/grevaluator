...
class EvidenceReport(metadataresource.MetadataResource):
    ...
    def elements_sequence(cls):
        """returning all elements names from ``EvidenceReport`` according specification,
...
class EvidenceReportRelatesTo(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``EvidenceReportRelatesTo`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class EvidenceReportSection(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``EvidenceReportSection`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class EvidenceReportSubject(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``EvidenceReportSubject`` according specification,
        with preserving original sequence order.
        """
...
class EvidenceReportSubjectCharacteristic(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``EvidenceReportSubjectCharacteristic`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
