...
class NamingSystem(canonicalresource.CanonicalResource):
    ...
    url: fhirtypes.Uri = Field(
        ...
        description=(
            ...
            "instance of this naming system is (or will be) published. This URL can"
            " be the target of a canonical reference. It SHALL remain the same when"
            " the naming system is stored on different servers."
        ),
        # if property is element of this resource.
        element_property=True,
    )
...
class NamingSystemUniqueId(backboneelement.BackboneElement):
    ...
    authoritative__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
    ...
    type: fhirtypes.Code = Field(
        None,
        alias="type",
        title="oid | uuid | uri | v2csmnemonic | other",
        description=(
        ...
        # note: Enum values can be used in validation,
        # but use in your own responsibilities, read official FHIR documentation.
        enum_values=["oid", "uuid", "uri", "v2csmnemonic", "other"],
    )
