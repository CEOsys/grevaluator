...
class ImplementationGuide(canonicalresource.CanonicalResource):
    ...
    fhirVersion: typing.List[fhirtypes.Code] = Field(
        None,
        alias="fhirVersion",
        ...
        description=(
            ...
            "e.g. [publication].[major].[minor], which is 4.5.0. for this version."
        ),
        # if property is element of this resource.
        element_property=True,
...
class ImplementationGuideDefinition(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideDefinition`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class ImplementationGuideDefinitionGrouping(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideDefinitionGrouping`` according specification,
        with preserving original sequence order.
        """
...
class ImplementationGuideDefinitionPage(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideDefinitionPage`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class ImplementationGuideDefinitionParameter(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideDefinitionParameter`` according specification,
        with preserving original sequence order.
        """
...
class ImplementationGuideDefinitionResource(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideDefinitionResource`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class ImplementationGuideDefinitionTemplate(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideDefinitionTemplate`` according specification,
        with preserving original sequence order.
        """
...
class ImplementationGuideDependsOn(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideDependsOn`` according specification,
        with preserving original sequence order.
        """
...
class ImplementationGuideManifest(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideManifest`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class ImplementationGuideManifestPage(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideManifestPage`` according specification,
        with preserving original sequence order.
        """
...
class ImplementationGuideManifestResource(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImplementationGuideManifestResource`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
