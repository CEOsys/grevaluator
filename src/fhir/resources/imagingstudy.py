...
class ImagingStudy(domainresource.DomainResource):
    ...
    modality: typing.List[fhirtypes.CodingType] = Field(
        ...
        description=(
            ...
            " both aquisition and non-aquisition modalities."
        ),
        # if property is element of this resource.
        element_property=True,
    )
    ...
    procedure: typing.List[fhirtypes.ImagingStudyProcedureType] = Field(
        None,
        alias="procedure",
...
class ImagingStudyProcedure(backboneelement.BackboneElement):
    """Disclaimer: Any field name ends with ``__ext`` doesn't part of
    Resource StructureDefinition, instead used to enable Extensibility feature
    for FHIR Primitive Data Types.
    ...
    resource_type = Field("ImagingStudyProcedure", const=True)

    valueCodeableConcept: fhirtypes.CodeableConceptType = Field(
        None,
        alias="valueCodeableConcept",
        title="The performed Procedure",
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImagingStudyProcedure`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
    ...
    def validate_one_of_many_2348(
        ...
        """
        one_of_many_fields = {"value": ["valueCodeableConcept", "valueReference"]}
...
class ImagingStudySeries(backboneelement.BackboneElement):
    ...
    modality: fhirtypes.CodingType = Field(
        ...
        description=(
            ...
            "aquisition and non-aquisition modalities."
        ),
        # if property is element of this resource.
        element_property=True,
    )
...
class ImagingStudySeriesPerformer(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ImagingStudySeriesPerformer`` according specification,
        with preserving original sequence order.
        """
