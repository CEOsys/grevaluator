...
class CapabilityStatement(canonicalresource.CanonicalResource):
...
class CapabilityStatementRestResourceOperation(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CapabilityStatementRestResourceOperation`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
