...
class ValueSet(canonicalresource.CanonicalResource):
...
class ValueSetCompose(backboneelement.BackboneElement):
    ...
    property: typing.List[fhirtypes.String] = Field(
        None,
        alias="property",
...
class ValueSetExpansionContainsProperty(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ValueSetExpansionContainsProperty`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class ValueSetExpansionProperty(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ValueSetExpansionProperty`` according specification,
        with preserving original sequence order.
        """
...
class ValueSetScope(backboneelement.BackboneElement):
    ...
    focus: fhirtypes.String = Field(
        None,
        alias="focus",
        title=(
            "General focus of the Value Set as it relates to the intended semantic "
            "space"
        ),
        description=(
            "The general focus of the Value Set as it relates to the intended "
            "semantic space. This can be the information about clinical relevancy "
            "or the statement about the general focus of the Value Set, such as a "
            "description of types of messages, payment options, geographic "
            "locations, etc."
        ),
        # if property is element of this resource.
        element_property=True,
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``ValueSetScope`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
