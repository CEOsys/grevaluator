...
class Citation(metadataresource.MetadataResource):
    ...
    def elements_sequence(cls):
        """returning all elements names from ``Citation`` according specification,
...
class CitationCitedArtifact(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifact`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactAbstract(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactAbstract`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactClassification(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactClassification`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactClassificationWhoClassified(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactClassificationWhoClassified`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactContributorship(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactContributorship`` according specification,
        with preserving original sequence order.
        """
...
class CitationCitedArtifactContributorshipEntry(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactContributorshipEntry`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactContributorshipEntryAffiliationInfo(
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactContributorshipEntryAffiliationInfo`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactContributorshipEntryContributionInstance(
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactContributorshipEntryContributionInstance`` according specification,
        with preserving original sequence order.
        """
...
class CitationCitedArtifactContributorshipSummary(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactContributorshipSummary`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactPart(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactPart`` according specification,
        with preserving original sequence order.
        """
...
class CitationCitedArtifactPublicationForm(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactPublicationForm`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactPublicationFormPeriodicRelease(
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactPublicationFormPeriodicRelease`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactPublicationFormPeriodicReleaseDateOfPublication(
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactPublicationFormPeriodicReleaseDateOfPublication`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactPublicationFormPublishedIn(backboneelement.BackboneElement):
    ...
    startDate: fhirtypes.Date = Field(
        None,
        alias="startDate",
        title="When the database was first available or when the book was published",
        description=None,
        # if property is element of this resource.
        element_property=True,
    )
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactPublicationFormPublishedIn`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactRelatesTo(backboneelement.BackboneElement):
    ...
    relationshipType: fhirtypes.CodeableConceptType = Field(
        ...
        title="How the cited artifact resource relates to the target artifact",
        description=None,
        # if property is element of this resource.
        element_property=True,
    )
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactRelatesTo`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationCitedArtifactStatusDate(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactStatusDate`` according specification,
        with preserving original sequence order.
        """
...
class CitationCitedArtifactTitle(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactTitle`` according specification,
        with preserving original sequence order.
        """
...
class CitationCitedArtifactVersion(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactVersion`` according specification,
        with preserving original sequence order.
        """
...
class CitationCitedArtifactWebLocation(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationCitedArtifactWebLocation`` according specification,
        with preserving original sequence order.
        """
...
class CitationClassification(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationClassification`` according specification,
        with preserving original sequence order.
        """
...
class CitationRelatesTo(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationRelatesTo`` according specification,
        with preserving original sequence order.
        """
        return [
            "id",
...
class CitationStatusDate(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationStatusDate`` according specification,
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "activity", "actual", "period"]
...
class CitationSummary(backboneelement.BackboneElement):
    ...
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from ``CitationSummary`` according specification,
        with preserving original sequence order.
        """
