...
MODEL_CLASSES = {
    ...
    "CapabilityStatement2": (None, ".capabilitystatement2"),
    "CapabilityStatement2Implementation": (None, ".capabilitystatement2"),
    "CapabilityStatement2Rest": (None, ".capabilitystatement2"),
    "CapabilityStatement2RestFeature": (None, ".capabilitystatement2"),
    "CapabilityStatement2RestInteraction": (None, ".capabilitystatement2"),
    "CapabilityStatement2RestResource": (None, ".capabilitystatement2"),
    "CapabilityStatement2RestResourceInteraction": (None, ".capabilitystatement2"),
    "CapabilityStatement2RestResourceOperation": (None, ".capabilitystatement2"),
    "CapabilityStatement2RestResourceSearchParam": (None, ".capabilitystatement2"),
    "CapabilityStatement2Software": (None, ".capabilitystatement2"),
    ...
    "ClinicalUseIssue": (None, ".clinicaluseissue"),
    "ClinicalUseIssueContraindication": (None, ".clinicaluseissue"),
    "ClinicalUseIssueContraindicationOtherTherapy": (None, ".clinicaluseissue"),
    "ClinicalUseIssueIndication": (None, ".clinicaluseissue"),
    "ClinicalUseIssueInteraction": (None, ".clinicaluseissue"),
    "ClinicalUseIssueInteractionInteractant": (None, ".clinicaluseissue"),
    "ClinicalUseIssueUndesirableEffect": (None, ".clinicaluseissue"),
    ...
    "Device": (None, ".device"),
    "DeviceAssociationStatus": (None, ".device"),
    ...
    "DeviceOperationalStatus": (None, ".device"),
    ...
    "ImagingStudyProcedure": (None, ".imagingstudy"),
    ...
    "IngredientSpecifiedSubstance": (None, ".ingredient"),
    ...
    "MedicationKnowledgeKineticCharacteristic": (None, ".medicationknowledge"),
    ...
    "MedicinalProductDefinitionPackage": (None, ".medicinalproductdefinition"),
    ...
    "OrderedDistribution": (None, ".ordereddistribution"),
    "OrderedDistributionInterval": (None, ".ordereddistribution"),
    ...
    "PermissionProcessingActivity": (None, ".permission"),
    "Person": (None, ".person"),
    ...
    "RegulatedAuthorizationRelatedDate": (None, ".regulatedauthorization"),
    ...
    "ResearchStudyClassification": (None, ".researchstudy"),
    ...
    "ResearchStudyRelatesTo": (None, ".researchstudy"),
    "ResearchStudyStatusDate": (None, ".researchstudy"),
    ...
    "StatisticAttributeEstimate": (None, ".statistic"),
    "StatisticAttributeEstimateAttributeEstimate": (None, ".statistic"),
    "StatisticModelCharacteristic": (None, ".statistic"),
    "StatisticModelCharacteristicVariable": (None, ".statistic"),
    "StatisticSampleSize": (None, ".statistic"),
    ...
    "SubscriptionTopicResourceTriggerCanFilterBy": (None, ".subscriptiontopic"),
    ...
    "SubstanceDefinitionStructureIsotope": (None, ".substancedefinition"),
...
def capabilitystatement2_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

    return fhir_model_validator("CapabilityStatement2", v)


def capabilitystatement2implementation_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("CapabilityStatement2Implementation", v)


def capabilitystatement2rest_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("CapabilityStatement2Rest", v)


def capabilitystatement2restfeature_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("CapabilityStatement2RestFeature", v)


def capabilitystatement2restinteraction_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("CapabilityStatement2RestInteraction", v)


def capabilitystatement2restresource_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("CapabilityStatement2RestResource", v)


def capabilitystatement2restresourceinteraction_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("CapabilityStatement2RestResourceInteraction", v)


def capabilitystatement2restresourceoperation_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("CapabilityStatement2RestResourceOperation", v)


def capabilitystatement2restresourcesearchparam_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("CapabilityStatement2RestResourceSearchParam", v)


def capabilitystatement2software_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("CapabilityStatement2Software", v)
...
def careplanactivityplannedactivitydetail_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):
...
def clinicaluseissue_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

    return fhir_model_validator("ClinicalUseIssue", v)


def clinicaluseissuecontraindication_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("ClinicalUseIssueContraindication", v)


def clinicaluseissuecontraindicationothertherapy_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("ClinicalUseIssueContraindicationOtherTherapy", v)


def clinicaluseissueindication_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("ClinicalUseIssueIndication", v)


def clinicaluseissueinteraction_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("ClinicalUseIssueInteraction", v)


def clinicaluseissueinteractioninteractant_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("ClinicalUseIssueInteractionInteractant", v)


def clinicaluseissueundesirableeffect_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("ClinicalUseIssueUndesirableEffect", v)
...
def deviceassociationstatus_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("DeviceAssociationStatus", v)
...
def deviceoperationalstatus_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("DeviceOperationalStatus", v)
...
def imagingstudyprocedure_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

    return fhir_model_validator("ImagingStudyProcedure", v)
...
def ingredientspecifiedsubstance_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("IngredientSpecifiedSubstance", v)
...
def inventoryreportinventorylistingitems_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):
...
def medicationknowledgekineticcharacteristic_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("MedicationKnowledgeKineticCharacteristic", v)
...
def medicinalproductdefinitionadministrableproduct_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("MedicinalProductDefinitionAdministrableProduct", v)
...
def medicinalproductdefinitionpackage_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("MedicinalProductDefinitionPackage", v)
...
def ordereddistribution_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

    return fhir_model_validator("OrderedDistribution", v)


def ordereddistributioninterval_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("OrderedDistributionInterval", v)
...
def permissionprocessingactivity_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("PermissionProcessingActivity", v)
...
def regulatedauthorizationrelateddate_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("RegulatedAuthorizationRelatedDate", v)
...
def researchstudyclassification_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("ResearchStudyClassification", v)
...
def researchstudyrelatesto_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

    return fhir_model_validator("ResearchStudyRelatesTo", v)


def researchstudystatusdate_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("ResearchStudyStatusDate", v)
...
def statistic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

    return fhir_model_validator("Statistic", v)


def statisticattributeestimate_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("StatisticAttributeEstimate", v)


def statisticattributeestimateattributeestimate_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("StatisticAttributeEstimateAttributeEstimate", v)


def statisticmodelcharacteristic_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("StatisticModelCharacteristic", v)


def statisticmodelcharacteristicvariable_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("StatisticModelCharacteristicVariable", v)


def statisticsamplesize_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

    return fhir_model_validator("StatisticSampleSize", v)
...
def subscriptiontopicresourcetriggercanfilterby_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("SubscriptionTopicResourceTriggerCanFilterBy", v)
...
def substancedefinitionstructureisotope_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("SubstanceDefinitionStructureIsotope", v)


def substancedefinitionstructureisotopemolecularweight_validator(
    v: Union[StrBytes, dict, Path, FHIRAbstractModel]
):

    return fhir_model_validator("SubstanceDefinitionStructureIsotopeMolecularWeight", v)
...
__all__ = [
    ...
    "administrableproductdefinitionrouteofadministrationtargetspecieswithdrawalperiod_validator",
    ...
    "capabilitystatement2_validator",
    "capabilitystatement2implementation_validator",
    "capabilitystatement2rest_validator",
    "capabilitystatement2restfeature_validator",
    "capabilitystatement2restinteraction_validator",
    "capabilitystatement2restresource_validator",
    "capabilitystatement2restresourceinteraction_validator",
    "capabilitystatement2restresourceoperation_validator",
    "capabilitystatement2restresourcesearchparam_validator",
    "capabilitystatement2software_validator",
    ...
    "clinicaluseissue_validator",
    "clinicaluseissuecontraindication_validator",
    "clinicaluseissuecontraindicationothertherapy_validator",
    "clinicaluseissueindication_validator",
    "clinicaluseissueinteraction_validator",
    "clinicaluseissueinteractioninteractant_validator",
    "clinicaluseissueundesirableeffect_validator",
    ...
    "device_validator",
    "deviceassociationstatus_validator",
    ...
    "deviceoperationalstatus_validator",
    ...
    "imagingstudyprocedure_validator",
    ...
    "ingredientspecifiedsubstance_validator",
    ...
    "medicationknowledgekineticcharacteristic_validator",
    ...
    "medicinalproductdefinitionadministrableproduct_validator",
    ...
    "medicinalproductdefinitionpackage_validator",
    ...
    "ordereddistribution_validator",
    "ordereddistributioninterval_validator",
    ...
    "permissionprocessingactivity_validator",
    "person_validator",
    ...
    "regulatedauthorizationrelateddate_validator",
    ...
    "researchstudyclassification_validator",
    ...
    "researchstudyrelatesto_validator",
    "researchstudystatusdate_validator",
    ...
    "statistic_validator",
    "statisticattributeestimate_validator",
    "statisticattributeestimateattributeestimate_validator",
    "statisticmodelcharacteristic_validator",
    "statisticmodelcharacteristicvariable_validator",
    "statisticsamplesize_validator",
    ...
    "subscriptiontopicresourcetriggercanfilterby_validator",
    ...
    "substancedefinitionstructureisotope_validator",
    "substancedefinitionstructureisotopemolecularweight_validator",
